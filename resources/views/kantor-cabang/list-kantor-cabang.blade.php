...
@section('container')
        ...
        <div class="row">
          ...
          <div class="col-auto ml-auto">
            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="{{ route('kantor-cabang.index') }}" method="get">
        ...
        <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-inline">
                                    ...
                                    <form action="{{ route('kantor-cabang.destroy', $value) }}" method="post">
                                        @csrf
                                        @method('delete')
            ...
            {{$kantorCabang->appends(Request::all())->links('vendor.pagination.custom')}}
        </div>
@endsection
