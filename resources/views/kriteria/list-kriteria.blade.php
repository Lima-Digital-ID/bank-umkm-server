...
@section('container')
        ...
        <div class="row">
          ...
          <div class="col-auto ml-auto">
            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="{{ route('kriteria.index') }}" method="get">
        ...
        <div class="table-responsive">
                ...
                <tbody>
                    ...
                    @foreach ($kriteria as $value)
                        <tr>
                            ...
                            <td>{{$value->kategoriKriteria->nama_kategori}}</td>
                            <td>
                                <div class="form-inline">
                                    <a href="{{ route('kriteria.edit', $value) }}" class="btn btn-success mr-2" title="Edit" data-toggle="tooltip"> <span class="fa fa-pen"></span> </a>
            ...
            {{$kriteria->appends(Request::all())->links('vendor.pagination.custom')}}
        </div>
@endsection
